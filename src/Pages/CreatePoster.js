...
//     wide: { name: 'Wide', width: 900, height: 600, aspectRatio: 3/2 },
...
//     if (billData.useTemplate && templateImage) {
//       const img = new Image();
//       img.crossOrigin = 'Anonymous';
//       img.onload = () => {
//         ctx.drawImage(img, 0, 0, canvas.width, canvas.height);
...
//       img.src = templateImage;
//     } else {
//       // Draw background for non-template mode
//       ctx.fillStyle = billData.backgroundColor;
...
//   const sampleTemplates = [
//     { id: 1, name: 'Modern', image: 'https://via.placeholder.com/800x1131/3b82f6/white?text=Modern+Template' },
//     { id: 2, name: 'Classic', image: 'https://via.placeholder.com/800x1131/f3f4f6/black?text=Classic+Template' },
//     { id: 3, name: 'Professional', image: 'https://via.placeholder.com/800x1131/1f2937/white?text=Professional+Template' },
//     { id: 4, name: 'Minimal', image: 'https://via.placeholder.com/800x1131/ffffff/black?text=Minimal+Template' }
//   ];
...
//     // Reset positions when frame size changes
...
//         link.click();
//       } catch (error) {
//         setErrorMessage(language === 'hi' ? 'बिल डाउनलोड करने में विफल' : 'Failed to download bill');
//       }
//     }
//   };
...
//       drawCanvasWithOverlays(true);
//     }
//   }, [templateImage, billData, textStyles, previewImage, logoSettings, language, selectedFrame, customSize]);
...
const BillBookCreator = () => {
  ...
  // Canvas size in pixels (internal storage)
  const [canvasSize, setCanvasSize] = useState({ width: 800, height: 1000 });
  
  // Conversion factors: 1 inch = 96px (standard web), 1 inch = 25.4mm
  ...
  // Display size based on current unit
  ...
  const sampleTemplates = [
    { id: 1, name: 'Modern', image: 'https://via.placeholder.com/800x1000/3b82f6/white?text=Modern+Template' },
    { id: 2, name: 'Classic', image: 'https://via.placeholder.com/800x1000/f3f4f6/black?text=Classic+Template' },
    { id: 3, name: 'Professional', image: 'https://via.placeholder.com/800x1000/1f2937/white?text=Professional+Template' },
    { id: 4, name: 'Minimal', image: 'https://via.placeholder.com/800x1000/ffffff/black?text=Minimal+Template' }
  ];
  ...
  }, [templateImage, billData, textStyles, previewImage, logoSettings, language, canvasSize]);
        ...
        <Col md={6}>
          <Card className="shadow-lg border-0">
            <CardBody className="p-4" style={{ maxHeight: '80vh', overflowY: 'auto' }}>
              ...
              {/* Canvas Size Selection with Units */}
              <div className="mb-4 p-3 border rounded bg-light">
                <div className="d-flex justify-content-between align-items-center mb-2">
