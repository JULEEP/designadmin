...
// CreateReceipt.jsx - COMPLETE WITH UNIT SYSTEM ONLY
import React, { useState, useRef, useEffect } from 'react';
import {
  Container,
  Form,
...
const CreateReceipt = () => {
  ...
  }, [templateImage, receiptData, textStyles, previewImage, logoSettings, language, canvasSize, unit]);
              ...
              <div className="mb-4 p-3 border rounded bg-light">
                <div className="d-flex justify-content-between align-items-center mb-2">
                  ...
                  <div className="btn-group btn-group-sm">
                    <Button color={unit === 'px' ? 'success' : 'secondary'} onClick={() => setUnit('px')}>px</Button>
                    <Button color={unit === 'in' ? 'success' : 'secondary'} onClick={() => setUnit('in')}>in</Button>
                    <Button color={unit === 'mm' ? 'success' : 'secondary'} onClick={() => setUnit('mm')}>mm</Button>
                  </div>
                </div>
