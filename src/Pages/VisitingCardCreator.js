...
//   // Frame size options for visiting cards
//   const frameSizes = {
//     standard: { name: 'Standard (3.5"×2")', width: 700, height: 400, aspectRatio: 1.75 },
//     square: { name: 'Square', width: 500, height: 500, aspectRatio: 1 },
//     wide: { name: 'Wide', width: 800, height: 350, aspectRatio: 2.285 },
//     mini: { name: 'Mini', width: 600, height: 300, aspectRatio: 2 },
//     custom: { name: 'Custom', width: 700, height: 400, aspectRatio: 1.75 }
//   };
  
//   const [selectedFrame, setSelectedFrame] = useState('standard');
//   const [customSize, setCustomSize] = useState({ width: 700, height: 400 });
...
//     name: 'जॉन डो',
//     designation: 'प्रबंधक',
//     company: 'माई बिजनेस प्राइवेट लिमिटेड',
//     address: '123 बिजनेस स्ट्रीट, डाउनटाउन, शहर - 123456',
...
//     name: 'John Doe',
//     designation: 'Manager',
//     company: 'My Business Pvt Ltd',
//     address: '123 Business Street, Downtown, City - 123456',
//     email: 'info@mybusiness.com',
//     phone: '+91 98765 43210',
//     website: 'www.mybusiness.com',
//     whatsapp: '',
...
//     name:        { fontSize: 20, fontWeight: 'bold',   color: '#000000', italic: false, underline: false, x: 120, y: 80,  show: true },
//     designation: { fontSize: 14, fontWeight: 'normal', color: '#666666', italic: false, underline: false, x: 120, y: 115, show: true },
//     company:     { fontSize: 16, fontWeight: 'bold',   color: '#3b82f6', italic: false, underline: false, x: 120, y: 150, show: true },
//     address:     { fontSize: 10, fontWeight: 'normal', color: '#666666', italic: false, underline: false, x: 120, y: 190, show: true },
//     email:       { fontSize: 10, fontWeight: 'normal', color: '#666666', italic: false, underline: false, x: 120, y: 220, show: true },
//     phone:       { fontSize: 12, fontWeight: 'bold',   color: '#3b82f6', italic: false, underline: false, x: 120, y: 250, show: true },
//     website:     { fontSize: 10, fontWeight: 'normal', color: '#666666', italic: false, underline: false, x: 120, y: 280, show: true }
//   });
...
//     if (language === 'hi') {
//       switch(field) {
//         case 'name': return hindiTranslations.name;
//         case 'designation': return hindiTranslations.designation;
//         case 'company': return hindiTranslations.company;
...
//         case 'website': return hindiTranslations.website;
//         default: return cardData[field];
//       }
//     }
...
//     }
//   }, [templateImage, cardData, textStyles, previewImage, logoSettings, language, selectedFrame, customSize]);
...
//       if (withOverlays) {
//         const fields = ['name', 'designation', 'company', 'address', 'email', 'phone', 'website'];
//         for (const field of fields) {
//           if (textStyles[field]?.show) {
//             const displayText = getDisplayText(field);
//             if (displayText) drawText(ctx, displayText, textStyles[field], cardData.fontFamily);
//           }
//         }
...
//     const textFields = ['name', 'designation', 'company', 'address', 'email', 'phone', 'website'];
...
//     { id: 1, name: 'Modern', image: 'https://placehold.co/700x400/3b82f6/white?text=Modern+Card' },
//     { id: 2, name: 'Classic', image: 'https://placehold.co/700x400/f3f4f6/black?text=Classic+Card' },
//     { id: 3, name: 'Professional', image: 'https://placehold.co/700x400/1f2937/white?text=Professional+Card' },
//     { id: 4, name: 'Minimal', image: 'https://placehold.co/700x400/ffffff/black?text=Minimal+Card' }
//   ];
...
//         link.click();
//       } catch (error) {
//         setErrorMessage(language === 'hi' ? 'कार्ड डाउनलोड करने में विफल' : 'Failed to download visiting card');
//       }
//     }
//   };
...
//     formData.append('designation', cardData.designation || '');
...
//     formData.append('whatsapp', cardData.whatsapp || '');
//     formData.append('instagram', cardData.instagram || '');
//     formData.append('facebook', cardData.facebook || '');
//     formData.append('twitter', cardData.twitter || '');
//     formData.append('linkedin', cardData.linkedin || '');
//     formData.append('textStyles', JSON.stringify(textStyles));
//     formData.append('logoSettings', JSON.stringify(logoSettings));
//     formData.append('useTemplate', cardData.useTemplate ? 'true' : 'false');
//     formData.append('language', language);
//     formData.append('showSocial', cardData.showSocial);
//     formData.append('showQR', cardData.showQR);
...
//         'https://designback.onrender.com/api/admin/createvisitingcard',
//         formData,
//         { headers: { 'Content-Type': 'multipart/form-data' } }
//       );
//       setSuccessMessage(language === 'hi' ? 'विजिटिंग कार्ड सफलतापूर्वक बनाया गया!' : 'Visiting card created successfully!');
//       setTimeout(() => navigate('/visitingcards'), 2000);
//     } catch (error) {
//       setErrorMessage(error.response?.data?.message || error.message || (language === 'hi' ? 'विजिटिंग कार्ड बनाने में त्रुटि' : 'Error creating visiting card'));
//     } finally {
//       setLoading(false);
//     }
//   };

//   const renderVisitingCard = () => {
//     const dimensions = getCurrentDimensions();
//     const cardStyle = {
//       backgroundColor: cardData.backgroundColor,
...
//           {cardData.showLogo && previewImage && logoSettings.show && (
...
//           )}
//           <div style={{ flex: 1 }}>
//             <h3 style={{ color: cardData.accentColor, marginBottom: '5px', fontSize: '20px', fontWeight: 'bold' }}>
//               {getDisplayText('name')}
//             </h3>
//             <p style={{ fontSize: '14px', marginBottom: '5px', color: '#666' }}>{getDisplayText('designation')}</p>
//             <p style={{ fontSize: '16px', marginBottom: '8px', color: cardData.accentColor, fontWeight: 'bold' }}>
//               {getDisplayText('company')}
//             </p>
//             <p style={{ fontSize: '10px', marginBottom: '5px', color: '#666' }}>{getDisplayText('address')}</p>
//             <p style={{ fontSize: '10px', marginBottom: '5px', color: '#666' }}>{getDisplayText('email')}</p>
//             <p style={{ fontSize: '12px', marginBottom: '5px', color: cardData.accentColor, fontWeight: 'bold' }}>
//               {getDisplayText('phone')}
//             </p>
//             <p style={{ fontSize: '10px', marginBottom: '0', color: '#666' }}>{getDisplayText('website')}</p>
//           </div>
//         </div>
//       </div>
//     );
...
//     { value: 'designation', label: 'Designation', icon: <FaBuilding /> },
...
//                 <CardTitle tag="h3" className="text-primary mb-0"><FaIdCard className="me-2" />Visiting Card Creator</CardTitle>
//                 <div>
...
//                   {language === 'hi' ? 'कार्ड साइज़ चुनें' : 'Select Card Size'}
//                 </Label>
//                 <Row>
//                   <Col xs={6} md={4} className="mb-2">
//                     <Button 
//                       color={selectedFrame === 'standard' ? 'primary' : 'outline-primary'}
//                       size="sm"
//                       onClick={() => handleFrameChange('standard')}
//                       className="w-100"
//                     >
//                       Standard (700×400)
//                     </Button>
...
//                   <Col xs={6} md={4} className="mb-2">
//                     <Button 
//                       color={selectedFrame === 'wide' ? 'primary' : 'outline-primary'}
//                       size="sm"
...
//                   <Col xs={6} md={4} className="mb-2">
//                     <Button 
//                       color={selectedFrame === 'mini' ? 'primary' : 'outline-primary'}
//                       size="sm"
//                       onClick={() => handleFrameChange('mini')}
//                       className="w-100"
//                     >
//                       Mini (600×300)
//                     </Button>
...
//                   <Label className="fw-bold mb-0"><FaImages className="me-2" />{language === 'hi' ? 'कार्ड टेम्पलेट' : 'Card Template'}</Label>
//                   <Button size="sm" color="primary" onClick={() => setShowTemplatePicker(!showTemplatePicker)}>
//                     {cardData.useTemplate ? (language === 'hi' ? 'टेम्पलेट बदलें' : 'Change Template') : (language === 'hi' ? 'टेम्पलेट अपलोड करें' : 'Upload Template')}
//                   </Button>
//                 </div>
//                 {showTemplatePicker && (
//                   <div className="mt-2">
...
//                 <NavItem><NavLink className={activeTab === '1' ? 'active' : ''} onClick={() => setActiveTab('1')}><FaUser /> {language === 'hi' ? 'कार्ड जानकारी' : 'Card Info'}</NavLink></NavItem>
...
//                           onChange={(e) => {
//                             setCardData({...cardData, [field.value]: e.target.value});
...
//                     <hr />
//                     <h6 className="mt-3">{language === 'hi' ? 'सोशल मीडिया' : 'Social Media'}</h6>
//                     <FormGroup check>
//                       <Label check>
//                         <Input type="checkbox" checked={cardData.showSocial} onChange={(e) => setCardData({...cardData, showSocial: e.target.checked})} />
//                         <span className="ms-2">{language === 'hi' ? 'सोशल मीडिया लिंक दिखाएं' : 'Show Social Media Links'}</span>
//                       </Label>
//                     </FormGroup>
                    
//                     {cardData.showSocial && (
//                       <>
//                         <FormGroup><Label><FaWhatsapp /> WhatsApp</Label><Input value={cardData.whatsapp} onChange={(e) => setCardData({...cardData, whatsapp: e.target.value})} placeholder="WhatsApp number" /></FormGroup>
//                         <FormGroup><Label><FaInstagram /> Instagram</Label><Input value={cardData.instagram} onChange={(e) => setCardData({...cardData, instagram: e.target.value})} placeholder="Instagram username" /></FormGroup>
//                         <FormGroup><Label><FaFacebook /> Facebook</Label><Input value={cardData.facebook} onChange={(e) => setCardData({...cardData, facebook: e.target.value})} placeholder="Facebook username" /></FormGroup>
//                       </>
//                     )}
//                   </TabPane>
...
//                         {cardData.useTemplate && <Alert color="info" className="mt-2"><FaArrowsAlt className="me-2" />Click and drag this element on preview to reposition</Alert>}
//                       </>
//                     )}
//                     <hr />
...
//                     </FormGroup>
//                     <FormGroup check>
//                       <Label check><Input type="checkbox" checked={cardData.showLogo} onChange={(e) => setCardData({...cardData, showLogo: e.target.checked})} /><span className="ms-2">Show Logo on Card</span></Label>
//                     </FormGroup>
...
//                           )}
//                         </Row>
//                         {cardData.useTemplate && <Alert color="info" className="mt-2"><FaArrowsAlt className="me-2" />Click and drag logo on preview to reposition</Alert>}
//                       </>
//                     )}
//                   </TabPane>
//                 </TabContent>
...
//                   <Button color="secondary" onClick={() => navigate('/visitingcards')}>{language === 'hi' ? 'रद्द करें' : 'Cancel'}</Button>
//                   <Button color="primary" type="submit" disabled={loading}>
//                     {loading ? <><FaSpinner className="spinner-border-sm me-1" /> Creating...</> : <><FaSave /> Create Visiting Card</>}
//                   </Button>
//                 </div>
//               </Form>
//             </CardBody>
...
//                 Live Preview
//                 {cardData.useTemplate && <small className="d-block text-muted"><FaMousePointer /> Click and drag ANY element to reposition</small>}
//               </CardTitle>
...
// export default VisitingCardCreator;
...
const VisitingCardCreator = () => {
  ...
  // Frame size options for visiting cards (in pixels internally)
  const frameSizes = {
    standard: { name: 'Standard', width: 700, height: 400 },
    square: { name: 'Square', width: 500, height: 500 },
    wide: { name: 'Wide', width: 800, height: 350 },
    mini: { name: 'Mini', width: 600, height: 300 },
    custom: { name: 'Custom', width: 700, height: 400 }
  };
  ...
  }, [templateImage, cardData, textStyles, previewImage, logoSettings, language, selectedFrame, customSize, unit]);
  ...
  const incrementSize = (dimension) => {
    ...
    if (dimension === 'width') {
      ...
      handleSizeChange(newWidthPx, currentDimensions.height);
    } else {
      const newHeightPx = convertToPx(parseFloat(displayHeight) + incrementValue, unit);
      handleSizeChange(currentDimensions.width, newHeightPx);
    }
  };
              ...
              <div className="mb-4 p-3 border rounded bg-light">
                <div className="d-flex justify-content-between align-items-center mb-2">
                  <Label className="fw-bold mb-0">
                    <FaRulerCombined className="me-2" />
                    {language === 'hi' ? 'कार्ड साइज़' : 'Card Size'}
                  </Label>
                ...
                <Row className="mb-2">
                  <Col xs={6} md={3} className="mb-2">
                    <Button 
                      color={selectedFrame === 'standard' ? 'primary' : 'outline-primary'}
                      size="sm"
                      onClick={() => handleFrameSelect('standard')}
                      className="w-100"
                    >
                      Standard
                    </Button>
                  ...
                  <Col xs={6} md={3} className="mb-2">
                    <Button 
                      color={selectedFrame === 'mini' ? 'primary' : 'outline-primary'}
                      size="sm"
                      onClick={() => handleFrameSelect('mini')}
                      className="w-100"
                    >
                      Mini
                    </Button>
