...
const VisitingCardCreator = () => {
  ...
  }, [templateImage, cardData, textStyles, previewImage, logoSettings, language]);
  ...
  const drawCanvasWithOverlays = (withOverlays = true) => {
    ...
    // Visiting card standard size: 3.5in x 2in (350px x 200px) but we'll use 700x400 for better quality
  ...
  const downloadCard = async () => {
    if (cardData.useTemplate && canvasRef.current) {
      ...
      try {
        ...
        setErrorMessage('Failed to download visiting card');
      }
    }
  };
          ...
          <div className="modal-dialog modal-dialog-centered modal-lg">
            <div className="modal-content bg-transparent border-0">
              <div className="modal-body text-center">
                {cardData.useTemplate && templateImage
                  ? <canvas ref={canvasRef} style={{ maxWidth: '100%', height: 'auto' }} width="700" height="400" />
                  : renderVisitingCard()
                }
                <div className="mt-3">
